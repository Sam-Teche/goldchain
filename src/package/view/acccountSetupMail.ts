const accountSetupMail = (supportMail: string): string => {
    return `
<!DOCTYPE html>
<html lang="en">
            ...
            <td>
                ...
                <div class="content-section">
                    <p style="font-size:13px; color:#fff;">
                       ...
                       <br/>
                       <br/>
                       Thank you for submitting your Source account information to GoldChain. Our compliance team is now reviewing your documents and verifying your account details.
                       <br/>
                       <br/>
                        You will receive another email once your account has been approved and is ready to activate.
                       <br/>
                       <br/>
                        If you have any questions in the meantime, feel free to contact us at 
                        <p style="color:#9C7E00 !important;">${supportMail}.</p>
                       <br/>
                       <br/>
                       GoldChain Support
...
export default accountSetupMail;