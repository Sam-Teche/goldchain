const purchaseRequestHtml = (sellerName: string, listingId: string, listedPrice: string, buyerName: string, url: string, expiry: string): string => {
    return `
<!DOCTYPE html>
<html lang="en">
    ...
    <table role="presentation" class="email-container">
        <tr>
            <td>
                ...
                <div class="content-section">
                    A buyer has requested to purchase your listing:
                </div>
                ...
                <div class="order-details">
                    <table class="details-table">
                        ...
                        <tr>
                            ...
                            <td class="details-value">${buyerName}</td>
                        </tr>
                    </table>
                </div>

                <div class="content-section">
                    Please review and accept or decline within ${expiry}.
                </div>

                <div class="button-row">
                    <a href="${url}" class="main-btn">REVIEW ORDER REQUEST</a>
                </div>
...
export default purchaseRequestHtml